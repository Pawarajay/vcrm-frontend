...
// import {
//     Calendar, Briefcase, User, FileText, Clock, TrendingUp,
...
//         ? Math.ceil((new Date(project.delivery_date) - new Date()) / 86400000)
//         : null;
...
//                     label={isOverdue ? 'Overdue Since' : 'Delivery Date'}
...
//                             pct >= 100 ? 'bg-green-500' : pct >= 60 ? 'bg-blue-500' : pct >= 30 ? 'bg-orange-400' : 'bg-red-400'
//                         }`}
//                         style={{ width: `${pct}%` }}
//                     />
//                 </div>
...
//                                 disabled={saving}
//                                 className="flex items-center gap-1 text-xs bg-blue-600 text-white px-3 py-1.5 rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors font-medium"
//                             >
...
//                             editing={editing}
//                             displayValue={
//                                 <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${STATUS_STYLE[project.status] || ''}`}>
//                                     {project.status}
//                                 </span>
//                             }
//                             editControl={
...
//                                     className="w-full text-sm border border-gray-300 rounded-lg px-2.5 py-1.5 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//                                 >
...
//                             editing={editing}
//                             displayValue={
//                                 <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium border ${prioConfig.cls}`}>
//                                     <PrioIcon size={11} />
...
//                     {/* Completion % quick edit */}
//                     {editing && (
//                         <div className="px-5 py-3">
//                             <p className="text-xs text-gray-500 mb-2 font-medium">Completion — {quickEdit.progress_percentage}%</p>
//                             <input
...
//                             editing={editing}
//                             displayValue={
//                                 <AvatarChip name={project.sales_owner} />
//                             }
//                             editControl={
//                                 <input
//                                     type="text"
...
//             {/* ── Row 4: Project info + Description side by side ── */}
...
//                         <InfoRow label="Linked Deal"   value={project.deal_id        ? `Deal #${project.deal_id}` : '—'} />
//                         <InfoRow label="Created by"    value={project.created_by_name || '—'} />
//                         <InfoRow label="Created on"    value={project.created_at ? new Date(project.created_at).toLocaleDateString('en-IN') : '—'} />
...
// function KpiCard({ color, label, value, icon, sub, badge }) {
//     const COLOR = {
...
//     };
//     return (
//         <div className={`rounded-xl border p-4 ${COLOR[color] || COLOR.blue}`}>
...
// function EditableRow({ label, editing, displayValue, editControl }) {
//     return (
//         <div>
