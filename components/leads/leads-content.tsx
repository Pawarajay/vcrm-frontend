...
//   GripVertical, ChevronDown, X, Users, TrendingUp,
...
// }) {
//   return (
//     <div className={cn("flex items-center gap-3 bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3", color)}>
...
//   const { leads, deleteLead, updateLead, currentUser } = useCRM();
...
//   // ── Stage change (drag & drop / dropdown) ─────────────────────────────────
...
//           <div className="min-w-0">
//             <h1 className="text-lg font-bold text-gray-900">Leads Pipeline</h1>
...
//             <SelectTrigger className={cn("h-9 w-36 rounded-xl text-sm border", stageFilter !== "all" ? "border-blue-400 bg-blue-50 text-blue-700" : "border-gray-200")}>
...
//             <SelectTrigger className={cn("h-9 w-36 rounded-xl text-sm border", serviceFilter !== "all" ? "border-blue-400 bg-blue-50 text-blue-700" : "border-gray-200")}>
...
//             <SelectTrigger className={cn("h-9 w-32 rounded-xl text-sm border", priorityFilter !== "all" ? "border-blue-400 bg-blue-50 text-blue-700" : "border-gray-200")}>
...
//             <button onClick={() => setView("kanban")} className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all", view === "kanban" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500")}>
//               <Kanban className="h-3.5 w-3.5" /> Board
//             </button>
//             <button onClick={() => setView("table")} className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all", view === "table" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500")}>
//               <LayoutList className="h-3.5 w-3.5" /> List
//             </button>
//           </div>

//           <Button onClick={() => setAddOpen(true)} className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-9 px-4 text-sm font-medium flex items-center gap-1.5 shrink-0 shadow-sm">
...
//           <StatPill icon={<Users className="h-5 w-5 text-blue-500" />}    label="Total Leads"    value={stats.total}           color="" />
//           <StatPill icon={<CheckCircle2 className="h-5 w-5 text-green-500" />} label="Won Deals" value={stats.won}             color="" />
//           <StatPill icon={<TrendingUp className="h-5 w-5 text-violet-500" />}  label="Pipeline Value" value={fmt(stats.pipeline)} color="" />
//           <StatPill
...
//             {/* Column headers */}
//             <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_auto] gap-4 px-5 py-3 bg-gray-50 border-b border-gray-100 text-xs font-semibold text-gray-400 uppercase tracking-wide">
//               <div>Client</div>
//               <div>Service</div>
//               <div>Stage</div>
//               <div>Amount</div>
...
//                       className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_auto] gap-4 px-5 py-3.5 items-center hover:bg-gray-50/60 cursor-pointer transition-colors group"
//                     >
//                       {/* Client */}
...
//                             {(lead as any).phone && (
//                               <button onClick={(e) => { e.stopPropagation(); call(lead); }} className="text-[10px] text-blue-500 hover:text-blue-700 flex items-center gap-0.5 font-medium">
...
//                       <div>
//                         {svc ? (
//                           <span className="text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100 px-2 py-0.5 rounded-lg whitespace-nowrap">
//                             {svc}
//                           </span>
...
//                         >
//                           <SelectTrigger className={cn("h-7 text-xs border rounded-full px-2.5 w-auto min-w-[110px] font-medium", sm.badge, "border-transparent focus:ring-0")} style={{ boxShadow: "none" }}>
...
//                       {/* Priority */}
//                       <div>
//                         <span className={cn("text-xs font-semibold px-2.5 py-1 rounded-full", pm.color)}>
//                           {pm.label}
//                         </span>
//                       </div>
...
//                       <div>
//                         {fud ? (
//                           <span className={cn("text-xs font-medium flex items-center gap-1", od ? "text-red-600" : "text-amber-600")}>
//                             {od ? <AlertCircle className="h-3 w-3" /> : <Clock className="h-3 w-3" />}
//                             {fmtDate(fud)}
//                             {od && " ⚠️"}
//                           </span>
//                         ) : (
//                           <button onClick={(e) => { e.stopPropagation(); fu(lead); }} className="text-xs text-gray-300 hover:text-blue-500 font-medium transition-colors">
//                             + Set date
//                           </button>
//                         )}
//                       </div>
...
//                           <MessageSquare className="h-3.5 w-3.5" />
//                         </button>
//                         <button onClick={() => fu(lead)} className="h-7 w-7 flex items-center justify-center rounded-lg hover:bg-amber-50 text-gray-400 hover:text-amber-600">
//                           <Bell className="h-3.5 w-3.5" />
//                         </button>
//                         <DropdownMenu>
//                           <DropdownMenuTrigger asChild>
