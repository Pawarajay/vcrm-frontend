...
// // Pages that should never show the sidebar regardless of auth
...
//   // No sidebar: public routes OR user not logged in (shows LoginForm)
//   if (isPublicRoute || (!isLoading && !user)) {
//     return <>{children}</>;
//   }

//   // While auth is loading, render children without sidebar to avoid flash
//   if (isLoading) {
//     return <>{children}</>;
//   }
