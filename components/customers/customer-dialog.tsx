...
// // Services that auto-enable recurring billing (SOW §2.4 & §2.6)
...
//   tags:           string[]
//   tagInput:       string
//   // Invoice defaults (SOW §2.6)
//   defaultTaxRate:      string
//   defaultDueDays:      string
//   defaultInvoiceNotes: string
//   // Recurring / retainer (SOW §2.4 & §2.6)
...
//   salesRep: "", source: "", notes: "", totalValue: "0", onboardingDate: "",
//   tags: [], tagInput: "",
...
//   // Re-sync if defaultOpen changes (e.g. edit mode opens retainer section)
...
//       </button>
//       {open && (
//         <div className="px-4 py-4 space-y-4 border-t border-gray-100">{children}</div>
//       )}
//     </div>
//   )
// }
...
//   mode:         "add" | "edit"
//   onSaved?:     () => void
//   leadId?:      string   // can be passed as prop OR read from URL
// }
...
//   // ── Auto-enable recurring for retainer services (add mode only) ──────────
//   useEffect(() => {
//     if (mode !== "add") return
...
//     // Accept Indian (+91 / 10-digit) OR international (+XX...)
...
//       // Use logged-in user's id as assignedTo (SOW §4 RBAC)
...
//                   className={selectCls}
//                   value={form.service}
//                   onChange={(e) => set({ service: e.target.value as TechService })}
//                 >
...
//                     ✓ Monthly retainer billing will be auto-enabled
//                   </p>
//                 )}
//               </Field>
//               <Field label="Status">
...
//                   placeholder="e.g. Pay via bank transfer"
//                   className={inputCls}
//                 />
//               </Field>
//             </div>
...
//           {/* ── §2.4 & §2.6 Monthly Retainer / Recurring Billing ────────
//                FIXED: defaultOpen respects BOTH add-mode auto-enable
//                AND edit-mode existing recurringEnabled value             */}
//           <CollapsibleSection
//             title="Monthly Retainer / Recurring Billing"
//             defaultOpen={form.recurringEnabled}
//           >
//             <div className="flex items-center justify-between py-1">
//               <div>
//                 <p className="text-sm font-medium text-gray-700">Enable Recurring Billing</p>
//                 <p className="text-xs text-gray-400 mt-0.5">
//                   Auto-generates invoices on a set schedule (SOW §2.6)
//                 </p>
//               </div>
//               <Switch
...
//                     onChange={(e) =>
//                       set({ recurringInterval: e.target.value as FormState["recurringInterval"] })
//                     }
//                   >
...
//                     onChange={(e) => set({ recurringService: e.target.value })}
//                     placeholder="e.g. WhatsApp API Monthly Plan"
//                     className={inputCls}
//                   />
//                 </Field>
//                 <Field
//                   label="Next Renewal Date"
//                   hint="Used to trigger renewal alerts (SOW §2.4)"
//                 >
//                   <Input
//                     type="date"
...
//               className="rounded-xl border-gray-200 text-gray-600 text-sm font-medium px-5"
//             >
//               Cancel
//             </Button>
//             <Button
//               type="submit"
//               disabled={isSubmitting}
//               className="rounded-xl bg-[#3A7AFE] hover:bg-[#2563EB] text-white text-sm font-medium px-5 shadow-sm"
//             >
//               {isSubmitting
