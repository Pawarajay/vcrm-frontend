...
//   // { name: "Tracking",   href: "/retainer-tracking", icon: CalendarRange },
...
//       )}>
//         {/* Brand icon */}
//         <div className="w-9 h-9 bg-[#2563EB] rounded-xl flex items-center justify-center shrink-0 shadow-sm">
//           <Zap className="h-5 w-5 text-white" strokeWidth={2.2} />
//         </div>

//         {!collapsed && (
//           <div className="min-w-0 overflow-hidden">
//             <div className="font-bold text-[15px] text-gray-900 leading-tight truncate">
//               Vasifytech
//             </div>
