...
// //   getAll:        (params?: any) =>
// //     apiFetch("/retainers", { params }),

// //   getById:       (id: string) =>
// //     apiFetch(`/retainers/${id}`),

// //   create:        (data: any) =>
// //     apiFetch("/retainers", { method: "POST", body: data }),

// //   update:        (id: string, data: any) =>
// //     apiFetch(`/retainers/${id}`, { method: "PATCH", body: data }),

// //   delete:        (id: string) =>
// //     apiFetch(`/retainers/${id}`, { method: "DELETE" }),

// //   renew:         (id: string, renewalDate: string) =>
// //     apiFetch(`/retainers/${id}/renew`, { method: "POST", body: { renewalDate } }),

// //   createPayment: (data: any) =>
// //     apiFetch("/retainer-payments", { method: "POST", body: data }),

// //   updatePayment: (id: string, data: any) =>
// //     apiFetch(`/retainer-payments/${id}`, { method: "PATCH", body: data }),

// //   getPayments:   (retainerId: string) =>
// //     apiFetch(`/retainers/${retainerId}/payments`),
// // }
// // ─── Leads API ────────────────────────────────────────────────────────────────
// //
// // FIX: updateSalesForm has been REMOVED. The crm-context now sends
...
// // old code sent the camelCase alias `salesFormData` which was not in
// // the backend's leadFieldMap.
...
//     createdBy?: string;
//     followUpDue?: string;
//     // FIX: added next_action so the filter is forwarded to the backend
//     nextAction?: string;
//     next_action?: string;
//     phone?: string;
//     dateSort?: string;
...
//   // The backend's leadFieldMap maps both snake_case and camelCase aliases.
//   // We rely on this for:
//   //   • sales_form_data  — lead form answers (previously broken via updateSalesForm)
//   //   • next_action      — next action field (was not persisting after refresh)
